...
public class RUDP_ACKPacket extends RUDPPacket {
	...
	private RUDP_ACKPacket(byte[] packet) throws PacketParsingException
	{
	      ...
	      this.advertised_window_size = packet[9];
	      
	      short checksum_should = NetUtils.bytesToShort(packet, 10);
	...
	public byte[] getPacket() {
        ...
        pkg[9] = this.advertised_window_size;
		...
		NetUtils.insertData(pkg, NetUtils.shortToBytes(this.checksum), 10);
